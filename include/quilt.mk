...
# Add by hangxu 2015/8/4
define Kernel/CommonFiles/Override
	-$(CP) $(CUSTOMER_COMMON_DIR)/kernel/$(BOARD)/* $(LINUX_DIR)/
endef
...
define Quilt/Template
  ...
  $($(2)STAMP_CHECKED): $($(2)STAMP_PREPARED)
	...
	$(call Kernel/CommonFiles/Override)
	$(call Kernel/ProfileFiles/Override)
	touch "$$@"
